...
import { IUser, ILibraryDetailedDataForClient, IHubInfo, ContentId, IContentMetadata, ContentParameters, ILibraryOverviewForClient, IFileStats, IAjaxResponse } from '@lumieducation/h5p-server/build/src/types';
import H5PEditor from '@lumieducation/h5p-server/build/src/H5PEditor';
import AjaxSuccessResponse from '@lumieducation/h5p-server/build/src/helpers/AjaxSuccessResponse';
/**
