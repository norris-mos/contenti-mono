...
var FileContentUserDataStorage = /** @class */ (function () {
    ...
    FileContentUserDataStorage.prototype.getContentUserData = function (contentId, dataType, subContentId, user) {
    ...
    FileContentUserDataStorage.prototype.getContentUserDataByContentIdAndUser = function (contentId, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        try {
                            return [2 /*return*/, dataList.filter(function (data) { return data.userId === user.id; })];
                        }
                        catch (error) {
