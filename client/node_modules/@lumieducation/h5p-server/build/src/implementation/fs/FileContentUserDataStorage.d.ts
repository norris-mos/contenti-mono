import { ContentId, IContentUserData, IContentUserDataStorage, IFinishedUserData, IUser } from '@lumieducation/h5p-server/build/src/types';
export default class FileContentUserDataStorage implements IContentUserDataStorage {
    ...
    getContentUserDataByContentIdAndUser(contentId: ContentId, user: IUser): Promise<IContentUserData[]>;
