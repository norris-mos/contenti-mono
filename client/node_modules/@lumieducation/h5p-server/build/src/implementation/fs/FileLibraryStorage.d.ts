...
import { IFileStats, IAdditionalLibraryMetadata, IInstalledLibrary, ILibraryMetadata, ILibraryName, ILibraryStorage } from '@lumieducation/h5p-server/build/src/types';
/**
