...
import LibraryName from '@lumieducation/h5p-server/build/src/LibraryName';
import { IFileStats, IFullLibraryName, IInstalledLibrary, ILanguageFileEntry, ILibraryFileUrlResolver, ILibraryInstallResult, ILibraryMetadata, ILibraryName, ILibraryStorage, ILockProvider, ISemanticsEntry, ITranslationFunction } from '@lumieducation/h5p-server/build/src/types';
/**
