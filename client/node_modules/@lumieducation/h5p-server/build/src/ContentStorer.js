            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.contentManager.contentStorage.addContent(metadata, parameters, user, contentId)];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, Promise.all(otherContentFiles.map(function (file) {
                                ...
                                return _this.contentManager.contentStorage.addFile(newContentId, localPath, readStream);
                            }))];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 6:
                        error_1 = _a.sent();
                        log.error(error_1);
                        return [4 /*yield*/, this.contentManager.contentStorage.deleteContent(newContentId)];
                    case 7:
                        _a.sent();
                        throw error_1;
