import { ContentId, ContentParameters, IContentStorage, IContentUserDataStorage, IH5PConfig, IH5PPlayerOptions, IIntegration, ILibraryStorage, IPlayerModel, IUrlGenerator, IUser, ITranslationFunction } from '@lumieducation/h5p-server/build/src/types';
