...
import { IH5PConfig, ITemporaryFileStorage, IUser } from '@lumieducation/h5p-server/build/src/types';
/**
...
export default class TemporaryFileManager {
     ...
     */
    constructor(storage: ITemporaryFileStorage, config: IH5PConfig);
    /**
