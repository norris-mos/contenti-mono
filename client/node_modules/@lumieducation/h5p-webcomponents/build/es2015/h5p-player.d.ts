...
import { IH5P, IH5PInstance } from '@lumieducation/h5p-webcomponents/build/es2015/h5p-types';
...
export declare class H5PPlayerComponent extends HTMLElement {
     ...
     * goes wrong.
     */
    get loadContentCallback(): (contentId: string) => Promise<IPlayerModel>;
    set loadContentCallback(callback: (contentId: string) => Promise<IPlayerModel>);
    /**
