...
import { IH5PConfig, IHubInfo, ILibraryInstallResult, ITranslationFunction, IUser } from './types';
/**
...
export default class ContentTypeInformationRepository {
     ...
     */
    constructor(contentTypeCache: ContentTypeCache, libraryManager: LibraryManager, config: IH5PConfig, translationCallback?: ITranslationFunction);
    private translator;
    private httpClient;
    /**
