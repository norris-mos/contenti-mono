...
var ContentUserDataManager_1 = __importDefault(require("./ContentUserDataManager"));
...
var H5PEditor = /** @class */ (function () {
    ...
    function H5PEditor(cache, config, libraryStorage, contentStorage, temporaryStorage, translationCallback, urlGenerator, options, contentUserDataStorage) {
        ...
        this.contentTypeCache = new ContentTypeCache_1.default(config, cache, (_a = this.options) === null || _a === void 0 ? void 0 : _a.getLocalIdOverride);
        this.contentHub = new ContentHub_1.default(config, cache);
        this.libraryManager = new LibraryManager_1.default(libraryStorage, this.urlGenerator.libraryFile, (_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.customization) === null || _c === void 0 ? void 0 : _c.alterLibrarySemantics, (_e = (_d = this.options) === null || _d === void 0 ? void 0 : _d.customization) === null || _e === void 0 ? void 0 : _e.alterLibraryLanguageFile, ((_f = this.options) === null || _f === void 0 ? void 0 : _f.enableLibraryNameLocalization)
            ? translationCallback
            : undefined, (_g = this.options) === null || _g === void 0 ? void 0 : _g.lockProvider, this.config);
        this.contentManager = new ContentManager_1.default(contentStorage, contentUserDataStorage);
        ...
        this.contentUserDataManager = new ContentUserDataManager_1.default(contentUserDataStorage);
        ...
        this.globalCustomScripts =
            ((_k = (_j = (_h = this.options) === null || _h === void 0 ? void 0 : _h.customization) === null || _j === void 0 ? void 0 : _j.global) === null || _k === void 0 ? void 0 : _k.scripts) || [];
        if ((_o = (_m = (_l = this.config.customization) === null || _l === void 0 ? void 0 : _l.global) === null || _m === void 0 ? void 0 : _m.editor) === null || _o === void 0 ? void 0 : _o.scripts) {
            this.globalCustomScripts = this.globalCustomScripts.concat((_p = this.config.customization.global) === null || _p === void 0 ? void 0 : _p.editor.scripts);
        }
        this.globalCustomStyles =
            ((_s = (_r = (_q = this.options) === null || _q === void 0 ? void 0 : _q.customization) === null || _r === void 0 ? void 0 : _r.global) === null || _s === void 0 ? void 0 : _s.styles) || [];
        if ((_v = (_u = (_t = this.config.customization) === null || _t === void 0 ? void 0 : _t.global) === null || _u === void 0 ? void 0 : _u.editor) === null || _v === void 0 ? void 0 : _v.styles) {
            this.globalCustomStyles = this.globalCustomStyles.concat((_w = this.config.customization.global) === null || _w === void 0 ? void 0 : _w.editor.styles);
        }
