            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.h5pEditor.contentStorage.getFileStats(contentId, filename, user)];
                    case 1:
                        stats = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.h5pEditor.temporaryStorage.getFileStats(filename, user)];
                    case 1:
                        stats = _a.sent();
                        range = getRangeCallback
                            ? getRangeCallback(stats.size)
