        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_r) {
                switch (_r.label) {
                    ...
                    case 15:
                        _p = (_l = _o.apply(_m, [_r.sent()]))
                            .concat;
                        return [4 /*yield*/, this.getAddonsByLibrary(metadata.mainLibrary, installedAddons)];
                    case 16:
                        dependencies = _j.apply(_h, [new (_k.apply(Set, [void 0, _p.apply(_l, [_r.sent()])]))()]);
                    ...
                    case 17:
                        ...
                        return [4 /*yield*/, this.generateIntegration(contentId, parameters, metadata, assets, mainLibrarySupportsFullscreen, user, language, {
                    ...
                    case 18:
                        model = (_q.integration = _r.sent(),
                            _q.scripts = this.listCoreScripts().concat(assets.scripts),
                            _q.styles = this.listCoreStyles().concat(assets.styles),
                            _q.translations = {},
                            _q.embedTypes = metadata.embedTypes,
                            _q.user = user,
                            _q);
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contentUserDataManager.generateContentUserDataIntegration(contentId, user)];
                    case 1: return [2 /*return*/, __assign.apply(void 0, [__assign.apply(void 0, [(_b.contents = (_c[_a] = (_d.contentUserData = _e.sent(),
                                ...
                                }, _b.libraryConfig = this.config.libraryConfig, _b.postUserStatistics = this.config.setFinishedEnabled, _b.saveFreq = this.config.contentUserStateSaveInterval !== false
                                    ? Math.round(Number(this.config.contentUserStateSaveInterval) /
                                        1000) || 1
                                    : false, _b.url = this.urlGenerator.baseUrl(), _b.hubIsEnabled = true, _b.fullscreenDisabled = this.config.disableFullscreen ? 1 : 0, _b), this.integrationObjectDefaults]), { user: {
                                    name: user.name,
                                    mail: user.email,
                                    id: user.id
                                } }])];
