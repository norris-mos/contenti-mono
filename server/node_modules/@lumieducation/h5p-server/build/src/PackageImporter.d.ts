...
import { ContentId, IContentMetadata, IH5PConfig, ILibraryInstallResult, IUser } from './types';
/**
...
export default class PackageImporter {
     ...
     * @param contentStorer
     */
    constructor(libraryManager: LibraryManager, config: IH5PConfig, contentManager?: ContentManager, contentStorer?: ContentStorer);
    /**
