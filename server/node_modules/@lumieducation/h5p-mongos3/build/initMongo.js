...
var log = new h5p_server_1.Logger('initMongo');
/**
 ...
 */
exports.default = (function (url, db, username, password) { return __awaiter(void 0, void 0, void 0, function () {
    var auth, client, error_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, mongodb_1.MongoClient.connect((_a = process.env.MONGODB_URL) !== null && _a !== void 0 ? _a : url, {
                        auth: auth,
            ...
            case 1:
                client = _c.sent();
                return [2 /*return*/, client.db((_b = process.env.MONGODB_DB) !== null && _b !== void 0 ? _b : db)];
            case 2:
                error_1 = _c.sent();
                log.error("Error while initializing MongoDB: ".concat(error_1.message));
                throw error_1;
