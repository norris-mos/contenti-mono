...
export declare class CallbackManager extends BaseCallbackManager implements BaseCallbackManagerMethods {
    ...
    handleChatModelStart(llm: Serialized, messages: BaseChatMessage[][], _runId?: string | undefined, _parentRunId?: string | undefined, extraParams?: Record<string, unknown> | undefined): Promise<CallbackManagerForLLMRun[]>;
